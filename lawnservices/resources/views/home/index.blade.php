                        ...
                        <div id="exTab1" class="container">	    
                            ...
                            <div class="tab-content clearfix">
                                <div class="tab-pane active" id="1a">
                                    @include('layouts.btn_services_scheduling')
                                </div>
                                <div class="tab-pane" id="2a">
                                    @include('layouts.btn_billing_details')
                                </div>
                                <div class="tab-pane" id="3a">
                                    @include('layouts.btn_future_jobs')
                                </div>
                                <div class="tab-pane" id="4a">
                                    @include('layouts.btn_past_jobs')
                                </div>
                                <div class="tab-pane" id="5a">
                                    @include('layouts.btn_previous_invoices')
                                </div>
                                <div class="tab-pane" id="6a">
                                    @include('layouts.btn_payments')
                                </div>
